...
In order to load your extension in a specific environments you will need to provide environment specific configuration file as an Content filein the `Content\Config` directory.
